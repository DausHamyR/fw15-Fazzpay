    ...
    With 30.000+ Users</div>
                    ...
                    <div className='grid gap-12 relative top-8'>
                        ...
                        <div className='grid gap-1'>
                            ...
                            <hr className='h-0.5 bg-slate-300' />
                            <Link href='/forgot-password' className='place-self-end top-2 relative font-semibold text-slate-500'>Forgot Password</Link>
                        </div>
                        <div className='grid gap-4'>
                            <button className='btn btn-primary w-full tracking-wider'>Login</button>
                            <div className='place-self-center tracking-wider text-slate-500'>Don’t have an account? Let’s <Link href='/register' className='text-blue-500 font-semibold'> Sign Up</Link></div>
                        </div>
                    </div>
                </div>
            </div>

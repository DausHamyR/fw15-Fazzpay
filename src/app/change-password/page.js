                    ...
                    <div className='grid justify-center content-center gap-12 relative top-24 w-full'>
                        <div className='grid gap-1'>
                            <div className='flex gap-4 items-center'>
                                <HiOutlineLockClosed />
                                <input type='email' placeholder='Current password' className='border-none pl-4 tracking-wider w-full border-slate-400'/>
                        ...
                        <div className='grid gap-1'>
                            <div className='flex gap-4 items-center'>
                                <HiOutlineLockClosed />
                                <input type='password' placeholder='New password' className='border-none pl-4 tracking-wider w-full border-slate-400'/>
                                <AiOutlineEyeInvisible />
                            </div>
                            <hr className='h-0.5 bg-slate-300 w-[500px]' />
                        </div>
                        <div className='grid gap-1'>
                            <div className='flex gap-4 items-center'>
                                <HiOutlineLockClosed />
                                <input type='password' placeholder='Repeat new password' className='border-none pl-4 tracking-wider w-full border-slate-400'/>
                                <AiOutlineEyeInvisible />
                            </div>
                            <hr className='h-0.5 bg-slate-300 w-[500px]' />
                        </div>
